                ...
                children: [
                  ...
                  Hero(
                    ...
                    child: Container(
                      ...
                      child: Icon(Icons.build_circle_rounded, size: 64, color: Theme.of(context).primaryColor),
                    ),
                  ),
                  ...
                  TextButton(
                    onPressed: () => Navigator.pushReplacementNamed(context, '/select-signup-role'),
                    child: RichText(
                      text: TextSpan(
                        style: TextStyle(fontSize: 14, color: Theme.of(context).colorScheme.onSurface),
                        children: [
                          TextSpan(text: "Don't have an account? ", style: TextStyle(color: Theme.of(context).colorScheme.onSurface.withOpacity(0.6))),
                          TextSpan(
                            text: "Sign Up",
